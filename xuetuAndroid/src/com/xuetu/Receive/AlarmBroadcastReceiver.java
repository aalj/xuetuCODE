...
public class AlarmBroadcastReceiver extends BroadcastReceiver {
	...
	public void onReceive(final Context context, Intent intent) {
		...
		if ("alarm1".equals(intent.getAction())) {
			...
			new AlertDialog.Builder(context).setIcon(android.R.drawable.btn_star).setTitle("闹钟").setMessage("你该起床了")
		...
		if ("alarm0".equals(intent.getAction())) {
			...
			new AlertDialog.Builder(context).setIcon(android.R.drawable.btn_star).setTitle("闹钟").setMessage("你该睡觉了")
					.setCancelable(false).setPositiveButton("确定", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
							vibrator.cancel();
