...
public class AddAlarm extends Baseactivity implements OnClickListener, OnCheckListener {
...
//			zaoshui_moshi_tv.setText("早起模式");
		...
		switchmy.setOncheckListener(this);
...
//	}
	...
	switchmy.setChecked(check);
	xianglingtixing=check;
	alarm.setTemp_index(0);//0表示提醒
