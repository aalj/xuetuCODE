 ...
 */
public abstract  class MyQuestionBaseAdapter<T> extends BaseAdapter {
    List<T> list = null;
    Context context;

    int reasouId = 0;

    public MyQuestionBaseAdapter(Context context, List<T> list, int reasouId) {
        this.list = list;
    ...
    public abstract void convert(ViewHodle viewHolder, T item,int position);
