<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<body>
		<table width="100%">
					...
					<table width="100%" height="100%">
						...
						<tr>
							...
							<td width="60%">
								<table width="100%">
									<tr height="70">
										<td align="center"><img src="./Images/xuetulogo.png" title="瑞曼科技" alt="瑞曼科技" style="width:100px;height:100px;" /></td>
									</tr>
									<tr height="274">
							...
							<td valign="top" id="form">
								<form action="/xuetuWeb/LoginServlet" method="post">
									<table valign="top" width="50%">
										<tr>
											<td colspan="2">
												<h4 style="letter-spacing:1px;font-size:16px;">学途  店家管理后台</h4></td>
										</tr>
										<tr>
											<td>管理员：</td>
											<td>
										...
										<td align="center"><a id="aaaaa" href='#' style="font-size:12px;" >忘记密码</a></td>
											<td align="center" ><a id="aaaaa" href='/xuetuWeb/register.jsp' style="font-size:12px;" >注册新用户</a></td>
										</tr>
			...
			<tr id="login_bot">
				<td colspan="2">
					<p>Copyright © 2014-2016 XueTu 网络工作室</p>
				</td>
			</tr>
		</table>
	</body>
