	...
	public void addCoupon(Coupon coupon,int sto_id){
		// 1、连数据库
				...
				try {
					...
					// 2、SQL语句
					String sql = "insert into coupon(sto_id,cou_info,cou_num,cou_Validity,cou_redeem_points,cou_name,cou_price,cou_create_time,cou_img)" + "values (?,?,?,?,?,?,?,?,?)";
					...
					prep.setString(9, coupon.getCouIma());
					// 5、执行sql语句
					prep.executeUpdate();
				} catch (Exception e) {
