...
/**
 * Servlet implementation class ChangeStuName
 */
@WebServlet("/ChangeStuNameServlet")
public class ChangeStuNameServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		boolean flag = personalServiceInter.ChangeName(stu_ID, decode_changeName);
