...
public class LoginActivity extends Baseactivity implements OnClickListener {
	...
	public void onclick(View v) {
		Log.e("Stone", "longin btu   onclick: " );
		switch (v.getId()) {
		...
		if (!TextUtils.isEmpty(telephone) && !TextUtils.isEmpty(password)) {
			...
			httpUtils.send(HttpMethod.POST, url, params, new RequestCallBack<String>() {
				...
				public void onFailure(HttpException arg0, String arg1) {
					Log.e(TAG, "getLogin: "+arg1 );
				}

				@Override
				public void onSuccess(ResponseInfo<String> arg0) {
					Log.e(TAG, "getLogin: 发送请求成功" );
					// 从服务器得值 是否是正确
			...
			Toast.makeText(getApplicationContext(), "请填写帐号或密码", Toast.LENGTH_SHORT).show();
		}
	}
